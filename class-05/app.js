...
let msg1=a + ' and ' + b + ' and ' + c + ' to ' + total;
let msg2='The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multi;
return [total,multi,msg1,msg2]
}
...
let msg=sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + total +  ' is their sum.';
return [total,msg]
}
...
multiplication=multiply(multiplication,multArr[2])[0];
let msg='The numbers' + multArr[0] + ',' + multArr[1]+ ',' + multArr[2] +  'have a product of' + multiplication + '.';
